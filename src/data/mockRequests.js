...
export const initialRequests = [
  ...
  { id: 'R05', shipperId: 'S4', origin: 'Ndola',   destination: 'Lusaka',   date: '2026-04-05', tonnes: 15, cargo: 'Copper cathodes',   status: 'matched', createdAt: '2026-03-27', acceptedBidId: 'BID02' },
];
